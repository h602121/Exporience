...
@Controller
@RequestMapping("/createexhibitor")
public class CreateExhibitorController {
    ...
    @GetMapping
    public String getCreateExhibitor(HttpSession session) {

        return "CreateExhibitorView";
    }
    ...
    public String postCreateExhibitor(@RequestParam String phonenumber, @RequestParam String firstName,
        ...
        if (!userService.gyldigFirstName(firstName)) {
            ...
            return "redirect:/createexhibitor";
        }
